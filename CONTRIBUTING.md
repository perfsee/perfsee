...
Thank you for investing your time in contributing to perfsee project!

Read our [Code of Coduct](./CODE_OF_CONDUCT.md) to keep our community approachable and respectable.

This guide details how to use issues and pull requests to improve perfsee project.
...
If you spot a problem with the problem, [search if an issue already exists](https://github.com/perfsee/perfsee/issues). If a related issue doesn't exist, you can open a new issue using [issue template](https://github.com/perfsee/perfsee/issues/new/choose).

### Solve an issue

Please check [DEVELOPMENT](DEVELOPMENT.md) in sub folder to get familiar with running and testing codes.
