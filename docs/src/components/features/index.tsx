import BundleImage from '@site/assets/pages/bundle.png'
import LabImage from '@site/assets/pages/lab.png'
import SourceImage from '@site/assets/pages/source.png'
import VSCodeImage from '@site/assets/pages/vscode.png'
