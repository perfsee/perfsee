CREATE TABLE IF NOT EXISTS `access_token` (
  ...
  CONSTRAINT `FK_4bd9bc00776919370526766eb43` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `app_version` (
  ...
  CONSTRAINT `FK_e1e62448be830d8da33cb2c6102` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `artifact` (
  ...
  CONSTRAINT `FK_5f5da14712db92faa1ee41ed737` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `artifact_entrypoint` (
  `id` int NOT NULL AUTO_INCREMENT,
  `project_id` int NOT NULL,
  ...
  CONSTRAINT `FK_957331498173532c9cd9464265c` FOREIGN KEY (`artifact_id`) REFERENCES `artifact` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_eda2a40bcd6d147b28a0839222e` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `artifact_name` (
  `id` int NOT NULL AUTO_INCREMENT,
  `project_id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  ...
  CONSTRAINT `FK_f9f0894817c6d628c1e3df51dd4` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `environment` (
  ...
  CONSTRAINT `FK_2b33a6c1d5c1276d3b502daf4de` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `github_check_runs_association` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `github_pull_requests_association` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `internal_id` (
  ...
  CONSTRAINT `FK_1b64943f3c41dfa4e71410eb6b8` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `job` (
  ...
  CONSTRAINT `FK_e100e9f656d36fa3f74d01f04b5` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `page` (
  ...
  CONSTRAINT `FK_8018adf3d04a1873595c021c886` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `page_with_competitor` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `page_with_env` (
  ...
  CONSTRAINT `FK_d08b36dd741538cbf2b7451fb0e` FOREIGN KEY (`env_id`) REFERENCES `environment` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_de9de6d3596e8b10a54cd0d6080` FOREIGN KEY (`page_id`) REFERENCES `page` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `page_with_profile` (
  `id` int NOT NULL AUTO_INCREMENT,
  `page_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `profile` (
  ...
  CONSTRAINT `FK_01f5c521c33e78c00ff78fd798d` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `runner_script` (
  `id` int NOT NULL AUTO_INCREMENT,
  `version` varchar(255) NOT NULL,
  `description` text,
...
CREATE TABLE IF NOT EXISTS `setting` (
  ...
  CONSTRAINT `FK_63751a9ebee56db104825bfbb47` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `snapshot` (
  ...
  CONSTRAINT `FK_459b31c42604b89a49be0c6fffc` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `snapshot_report` (
  ...
  CONSTRAINT `FK_787259d4365648b21c28eb20aec` FOREIGN KEY (`snapshot_id`) REFERENCES `snapshot` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_d2df6dff88d77a3df1d3e3ae606` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS `timer` (
  ...
  CONSTRAINT `FK_06b72da2964551e83add8d9abc8` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `typeorm_migration_table` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `user_connected_account` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `user_permission` (
  ...
  CONSTRAINT `FK_2305dfa7330dd7f8e211f4f35d9` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_e18d264897f25a0ddb0bce75cb1` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
CREATE TABLE IF NOT EXISTS `user_starred_project` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `project_id` int NOT NULL,
  PRIMARY KEY (`id`),
