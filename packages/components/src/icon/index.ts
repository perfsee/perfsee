...
export { default as TreemapIcon } from './treemap.svg'
export * from './score-icon'
export { default as TreeShakeIcon } from './tree-shake.svg'
export { default as SideEffectIcon } from './side-effect.svg'
