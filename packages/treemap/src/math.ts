...
export class AffineTransform {
  ...
  constructor(
    public readonly m00 = 1,
    public readonly m01 = 0,
    public readonly m02 = 0,
    public readonly m10 = 0,
    public readonly m11 = 1,
    public readonly m12 = 0,
  ) {}

  withScale(s: Vec2) {
    const { m01, m02, m10, m12 } = this
    return new AffineTransform(s.x, m01, m02, m10, s.y, m12)
  }
  ...
  withTranslation(t: Vec2) {
    ...
    return new AffineTransform(m00, m01, t.x, m10, m11, t.y)
  }
