  ...
  var require_backend = __commonJS({
    'node_modules/react-devtools-inline/dist/backend.js'(exports, module) {
      module.exports = (function (modules) {
        ...
        11: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          __webpack_require__.d(__webpack_exports__, 'd', function () {
            return meta
          })
        ...
        12: function (module2, __webpack_exports__, __webpack_require__) {
          ...
          function cleanForBridge(data, isPathAllowed, path = []) {
            if (data !== null) {
              ...
              const cleanedData = Object(hydration['a'])(data, cleanedPaths, unserializablePaths, path, isPathAllowed)
              return {
                data: cleanedData,
          ...
          function copyWithDelete(obj, path, index = 0) {
            ...
            const updated = Object(isArray['a'])(obj)
              ? obj.slice()
              : {
                  ...obj,
                }
            if (index + 1 === path.length) {
              if (Object(isArray['a'])(updated)) {
        ...
        13: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          __webpack_require__.d(__webpack_exports__, 'a', function () {
              ...
              if (
                ...
                ;(function (a) {
                  ...
                  function h(a2, b2, c2, d2) {
                    ;(this.onFulfilled = 'function' == typeof a2 ? a2 : null),
                      (this.onRejected = 'function' == typeof b2 ? b2 : null),
                      (this.resolve = c2),
                      (this.reject = d2)
                  }
                  function i(a2, b2, c2) {
                  ...
                  ;(c.prototype['catch'] = function (a2) {
                    ...
                    (c.resolve = function (a2) {
                      return a2 && 'object' == typeof a2 && a2.constructor === c
                        ? a2
                        : new c(function (b2) {
                            b2(a2)
                          })
        ...
        20: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          const isArray = Array.isArray
          __webpack_exports__['a'] = isArray
        },
        206: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          ...
          function iterateNodes(nodeToData2, execute) {
            nodeToData2.forEach(({ count, rect }, node) => {
  ...
  `
          ...
          class agent_Agent extends events['a'] {
            constructor(bridge) {
              ...
              _defineProperty(this, 'inspectElement', ({ forceFullData, id, path, rendererID, requestID }) => {
                const renderer = this._rendererInterfaces[rendererID]
                if (renderer == null) {
                  console.warn(`Invalid renderer id "${rendererID}" for element "${id}"`)
                } else {
              ...
              _defineProperty(this, 'overrideError', ({ id, rendererID, forceError }) => {
                const renderer = this._rendererInterfaces[rendererID]
                if (renderer == null) {
                  console.warn(`Invalid renderer id "${rendererID}" for element "${id}"`)
                } else {
              ...
              bridge.send('isSynchronousXHRSupported', Object(utils['k'])())
          ...
          function installHook(target) {
            ...
            let unpatchFn = null
            function patchConsoleForInitialRenderInStrictMode({ hideConsoleLogsInStrictMode, browserTheme }) {
            ...
            switch (type) {
              ...
              case 'array':
                if (showFormattedValue) {
                  ...
                  const length = utils_hasOwnProperty.call(data, hydration['d'].size)
                    ? data[hydration['d'].size]
                    : data.length
                  return `Array(${length})`
                }
              case 'typed_array':
        ...
        34: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          __webpack_require__.d(__webpack_exports__, 'a', function () {
        ...
        35: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
        ...
        43: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
        ...
        44: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          ;(function (global) {
            __webpack_require__.d(__webpack_exports__, 'd', function () {
            ...
            function registerRenderer(renderer, onErrorOrWarning) {
              const { currentDispatcherRef, getCurrentFiber, findFiberByHostInstance, version } = renderer
              if (typeof findFiberByHostInstance !== 'function') {
                return
              }
              if (currentDispatcherRef != null && typeof getCurrentFiber === 'function') {
                const { ReactTypeOfWork } = Object(_renderer__WEBPACK_IMPORTED_MODULE_1__['b'])(version)
                        ...
                        if (current != null) {
                          try {
                            ...
                            if (shouldAppendWarningStack) {
                              const componentStack = Object(
                                _DevToolsFiberComponentStack__WEBPACK_IMPORTED_MODULE_2__['b'],
                      ...
                      if (!consoleSettingsRef.hideConsoleLogsInStrictMode) {
                        if (isNode) {
                          originalMethod(
                            ...
                            Object(_utils__WEBPACK_IMPORTED_MODULE_0__['f'])(...args),
                          )
                        } else {
            ...
            function patchConsoleUsingWindowValues() {
              ...
              const appendComponentStack =
                (_castBool = Object(_utils__WEBPACK_IMPORTED_MODULE_4__['a'])(
                  window.__REACT_DEVTOOLS_APPEND_COMPONENT_STACK__,
                )) !== null && _castBool !== void 0
                  ? _castBool
                  : true
              const breakOnConsoleErrors =
                (_castBool2 = Object(_utils__WEBPACK_IMPORTED_MODULE_4__['a'])(
                  window.__REACT_DEVTOOLS_BREAK_ON_CONSOLE_ERRORS__,
                )) !== null && _castBool2 !== void 0
                  ? _castBool2
                  : false
              const showInlineWarningsAndErrors =
                (_castBool3 = Object(_utils__WEBPACK_IMPORTED_MODULE_4__['a'])(
                  window.__REACT_DEVTOOLS_SHOW_INLINE_WARNINGS_AND_ERRORS__,
                )) !== null && _castBool3 !== void 0
                  ? _castBool3
                  : true
              const hideConsoleLogsInStrictMode =
                (_castBool4 = Object(_utils__WEBPACK_IMPORTED_MODULE_4__['a'])(
                  window.__REACT_DEVTOOLS_HIDE_CONSOLE_LOGS_IN_STRICT_MODE__,
                )) !== null && _castBool4 !== void 0
                  ? _castBool4
                  : false
              const browserTheme =
                (_castBrowserTheme = Object(_utils__WEBPACK_IMPORTED_MODULE_4__['b'])(
        ...
        45: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          __webpack_require__.d(__webpack_exports__, 'a', function () {
        ...
        51: function (module2, exports2, __webpack_require__) {
          ...
          ;(function (root, factory) {
            'use strict'
            if (true) {
              !((__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(84)]),
              (__WEBPACK_AMD_DEFINE_FACTORY__ = factory),
              (__WEBPACK_AMD_DEFINE_RESULT__ =
                typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function'
                  ? __WEBPACK_AMD_DEFINE_FACTORY__.apply(exports2, __WEBPACK_AMD_DEFINE_ARRAY__)
            ...
            return {
              ...
              parseOpera11: function ErrorStackParser$$parseOpera11(error) {
                ...
                return filtered.map(function (line) {
                  ...
                  var functionName =
                    functionCall.replace(/<anonymous function(: (\w+))?>/, '$2').replace(/\([^)]*\)/g, '') || void 0
                  var argsRaw
        ...
        53: function (module2, exports2, __webpack_require__) {
          ;(function (global) {
        ...
        54: function (module2, exports2, __webpack_require__) {
          'use strict'
        ...
        70: function (module2, __webpack_exports__, __webpack_require__) {
          'use strict'
          __webpack_require__.d(__webpack_exports__, 'b', function () {
          ...
          function useState(initialState) {
            const hook = nextHook()
            const state =
              hook !== null ? hook.memoizedState : typeof initialState === 'function' ? initialState() : initialState
            hookLog.push({
              primitive: 'State',
              stackError: new Error(),
              value: state,
          ...
          const DispatcherProxy =
            typeof Proxy === 'undefined' ? Dispatcher : new Proxy(Dispatcher, DispatcherProxyHandler)
          ...
          function isReactWrapper(functionName, primitiveName) {
            ...
            return (
              functionName.lastIndexOf(expectedPrimitiveName) === functionName.length - expectedPrimitiveName.length
            )
          }
          ...
          function inspectHooksOfFiber(fiber, currentDispatcher, includeHooksSource = false) {
            ...
            if (
              fiber.tag !== ReactWorkTags_FunctionComponent &&
              fiber.tag !== ReactWorkTags_SimpleMemoComponent &&
              fiber.tag !== ReactWorkTags_ForwardRef
            ) {
                      ...
                      if (event.type === 'schedule-state-update') {
                        ...
                        if (fiberStack && currentDispatcherRef != null) {
                          event.componentStack = fiberStack.reduce((trace, fiber) => {
                            return (
                              trace + Object(DevToolsFiberComponentStack['a'])(workTagMap, fiber, currentDispatcherRef)
                            )
                          }, '')
                        }
                      }
          ...
          function getInternalReactConstants(version) {
            ...
            if (Object(backend_utils['i'])(version, '17.0.2')) {
              ReactPriorityLevels = {
                ImmediatePriority: 1,
            ...
            if (Object(backend_utils['j'])(version, '18.0.0-alpha')) {
              StrictModeBits = 24
            } else if (Object(backend_utils['j'])(version, '16.9.0')) {
              StrictModeBits = 1
            } else if (Object(backend_utils['j'])(version, '16.3.0')) {
              StrictModeBits = 2
            }
            let ReactTypeOfWork = null
            if (Object(backend_utils['i'])(version, '17.0.1')) {
              ReactTypeOfWork = {
                CacheComponent: 24,
                ClassComponent: 1,
                ContextConsumer: 9,
            ...
            } else if (Object(backend_utils['j'])(version, '17.0.0-alpha')) {
              ReactTypeOfWork = {
                CacheComponent: -1,
                ClassComponent: 1,
                ContextConsumer: 9,
            ...
            } else if (Object(backend_utils['j'])(version, '16.6.0-beta.0')) {
              ReactTypeOfWork = {
                CacheComponent: -1,
                ClassComponent: 1,
                ContextConsumer: 9,
            ...
            } else if (Object(backend_utils['j'])(version, '16.4.3-alpha')) {
              ReactTypeOfWork = {
                CacheComponent: -1,
                ClassComponent: 2,
                ContextConsumer: 11,
          ...
          function attach(hook, rendererID, renderer, global) {
            ...
            const { getDisplayNameForFiber, getTypeSymbol, ReactPriorityLevels, ReactTypeOfWork, StrictModeBits } =
            ...
            function getOrGenerateFiberID(fiber) {
              ...
              if (fiberToIDMap.has(fiber)) {
                ...
                const { alternate: alternate2 } = fiber
            ...
            function handlePostCommitFiberRoot(root) {
              if (isProfiling && rootSupportsProfiling(root)) {
                if (currentCommitProfilingMetadata !== null) {
                  const { effectDuration, passiveEffectDuration } = Object(backend_utils['h'])(root)
            ...
            function inspectElementRaw(id) {
              ...
              return {
                ...
                canToggleSuspense:
                  supportsTogglingSuspense && (!isTimedOutSuspense || forceFallbackForSuspenseIDs.has(id)),
                canViewSource,
                hasLegacyContext,
                key: key != null ? key : null,
            ...
            function inspectElement(requestID, id, path, forceFullData) {
                ...
                if (!hasElementUpdatedSinceLastInspected) {
                  if (path !== null) {
                    ...
                    return {
                      ...
                      type: 'hydrated-path',
                      path,
                      value: Object(backend_utils['a'])(
                        Object(utils['n'])(mostRecentlyInspectedElement, path),
              ...
              cleanedInspectedElement.context = Object(backend_utils['a'])(
                cleanedInspectedElement.context,
                createIsPathAllowed('context', null),
              )
              cleanedInspectedElement.hooks = Object(backend_utils['a'])(
                cleanedInspectedElement.hooks,
                createIsPathAllowed('hooks', 'hooks'),
              )
              cleanedInspectedElement.props = Object(backend_utils['a'])(
                cleanedInspectedElement.props,
                createIsPathAllowed('props', null),
              )
              cleanedInspectedElement.state = Object(backend_utils['a'])(
        ...
        80: function (module2, exports2, __webpack_require__) {
          ;(function (global) {
            ...
            exports2.clearImmediate =
              (typeof self !== 'undefined' && self.clearImmediate) ||
              (typeof global !== 'undefined' && global.clearImmediate) ||
              (this && this.clearImmediate)
          }.call(this, __webpack_require__(40)))
        },
        81: function (module2, exports2, __webpack_require__) {
        ...
        82: function (module2, exports2, __webpack_require__) {
          'use strict'
          ...
          function insert(self2, node, value) {
            var inserted =
              node === self2.head ? new Node2(value, null, node, self2) : new Node2(value, node, node.next, self2)
        ...
        83: function (module2, exports2, __webpack_require__) {
          'use strict'
