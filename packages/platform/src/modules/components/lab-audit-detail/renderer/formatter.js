...
export class Formatter {
   ...
   * @return {string}
   */
  static _formatNumberWithGranularity(number, granularity, opts = {}) {
    ...
    formatter = CachedNumberFormatters.get(cacheKey)
    if (!formatter) {
   ...
   * @return {string}
   */
  static formatNumber(number, granularity) {
   ...
   * @return {string}
   */
  static formatBytesToKiB(size, granularity = undefined) {
   ...
   * @return {string}
   */
  static formatBytesToMiB(size, granularity = undefined) {
   ...
   * @return {string}
   */
  static formatBytes(size, granularity = 1) {
   ...
   * @return {string}
   */
  static formatBytesWithBestUnit(size, granularity = 0.1) {
   ...
   * @return {string}
   */
  static formatKbps(size, granularity = undefined) {
    return this._formatNumberWithGranularity(size, granularity, {
      style: 'unit',
   ...
   * @return {string}
   */
  static formatMilliseconds(ms, granularity = undefined) {
   ...
   * @return {string}
   */
  static formatSeconds(ms, granularity = undefined) {
