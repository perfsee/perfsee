...
export const WebhookEditForm = ({ webhook: defaultWebhook, isCreate, closeModal, onSubmit }: Props) => {
  ...
  const handleContentTypeChange = useCallback((_: any, value?: IDropdownOption<any>) => {
    setWebhook((prev) => ({ ...prev, contentType: value?.key as string }))
  }, [])
  ...
  return (
    <Stack tokens={{ childrenGap: 6 }}>
      ...
      <Dropdown
        ...
        defaultSelectedKey={webhook.contentType}
      />
