...
export class RowAtlas<K> {
  private readonly texture: Graphics.Texture
  private readonly renderTarget: Graphics.RenderTarget
  private readonly rowCache: LRUCache<K, number>
  private readonly clearLineBatch: RectangleBatch
