...
export class FlamechartViewRenderer {
  flamechart: Flamechart | null = null
  flamechartRenderer: FlamechartRenderer | null = null
  timings: Timing[] = []
  images: FlamechartImage[] = []
  ...
  private renderOverlay(width: number, height: number, viewport: Rect, props: RenderProps): RenderFeedback {
    ...
    if (this.flamechart) {
...

      {
        ...
        matchedFrameBatch.stroke(
          ctx,
          theme.searchMatchPrimaryColor,
          props.matchedStrokeWidth + props.matchedOutlineWidth,
        )
